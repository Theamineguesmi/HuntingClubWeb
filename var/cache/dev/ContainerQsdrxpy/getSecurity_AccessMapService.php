...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/efconnect'), [0 => 'ROLE_USER'], NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/elfinder'), [0 => 'ROLE_USER'], NULL);
