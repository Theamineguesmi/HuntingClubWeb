...
class Article extends \BlogBundle\Entity\Article implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BlogBundle\\Entity\\Article' . "\0" . 'id', '' . "\0" . 'BlogBundle\\Entity\\Article' . "\0" . 'titre', '' . "\0" . 'BlogBundle\\Entity\\Article' . "\0" . 'contenu', '' . "\0" . 'BlogBundle\\Entity\\Article' . "\0" . 'dateAjout', '' . "\0" . 'BlogBundle\\Entity\\Article' . "\0" . 'dateModif', '' . "\0" . 'BlogBundle\\Entity\\Article' . "\0" . 'photopath'];
        }
