 ...
 */
class Commentaire extends \BlogBundle\Entity\Commentaire implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BlogBundle\\Entity\\Commentaire' . "\0" . 'id', '' . "\0" . 'BlogBundle\\Entity\\Commentaire' . "\0" . 'idArticle', '' . "\0" . 'BlogBundle\\Entity\\Commentaire' . "\0" . 'idUser', '' . "\0" . 'BlogBundle\\Entity\\Commentaire' . "\0" . 'contenu', '' . "\0" . 'BlogBundle\\Entity\\Commentaire' . "\0" . 'dateAjout', '' . "\0" . 'BlogBundle\\Entity\\Commentaire' . "\0" . 'dateModif', '' . "\0" . 'BlogBundle\\Entity\\Commentaire' . "\0" . 'nbjaime'];
        }
